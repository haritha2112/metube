...
<html>
	...
	<body align = "center">
		...
		<table class="navigation-grid">
			<tr>
				<td class="grid-item"><a href="Inbox.php"> Inbox </a></td>
				<td class="grid-item"><a href="SendMessage.php"> Send Message </a></td>
				<td class="grid-item"><a href="GroupMessage.php"> Group Messages </a></td>
			</tr>
		</table>