<?php
	...
	if(isset($_POST['subscribe_button'])){
		...
		subscribe_to_channel($c_id, $current_uid);
	}
?>
<html>
	<head>
	...
	<body>
		<div class="container">
			...
			<div class="row">
				<div class="col-md-9">
					<h1 class="sub-title"> Search Channels </h1>
				</div>
			...
			<?php
				$current_uid = get_current_uid($_SESSION['username']);
				$channels = get_unsubscribed_channels($current_uid);
			?>
			<div class="row">
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										...
										<form method="post" action="">
											<button type="submit" class="btn btn-info pull-right subscribe-button" name="subscribe_button">Subscribe</button>
